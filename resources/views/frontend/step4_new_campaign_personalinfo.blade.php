                ...
                <div class="inner">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-9 mx-auto">
                            ...
                            <form action="{{route('campaignPersonalInfo_post')}}" method="POST">
                                @csrf

                            
                                    <h4 class="fs-4  mb-2 darkerGrotesque-bold txt-secondary">
                                        Email</h4>
                                    <input type="email" class="my-3 form-control fs-4" placeholder="Your email" id="email" name="email" value="{{ $step4dataForm['email'] ?? ''  }}" required>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-lg-6 ">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="{{ $step4dataForm['name'] ?? ''  }}" required>
                                        </div>
                                        <div class="col-lg-6 ">
                                            <label for="family_name" class="fs-5  mb-2 darkerGrotesque-medium fw-bold"> Family Name </label>
                                            <input type="text" name="family_name" class="form-control" id="family_name" value="{{ $step4dataForm['family_name'] ?? ''  }}" required>
                                        </div>
                                        ...
                                        <div class="col-lg-6 ">
                                            ...
                                            <input type="text" name="phone" class="form-control" id="phone" value="{{ $step4dataForm['email'] ?? ''  }}" required>
                                        </div>
                                        ...
                                        <div class="col-lg-12 ">
                                            ...
                                            <div class="col-lg-6 ">
                                                ...
                                                <input type="text" name="city" class="form-control" id="city" value="{{ $step4dataForm['city'] ?? ''  }}" required>
                                            </div>
                                            <div class="col-lg-6 ">
                                                <label for="street_name" class="fs-5 mb-2 darkerGrotesque-medium fw-bold">Street Name</label>
                                                <input type="text" name="street_name" class="form-control" id="street_name" value="{{ $step4dataForm['street_name'] ?? ''  }}" required>
                                            </div>
                                            <div class="col-lg-6 ">
                                                <label for="town" class="fs-5  mb-2 darkerGrotesque-medium fw-bold"> Town </label>
                                                <input type="text" name="town" class="form-control" id="town" value="{{ $step4dataForm['town'] ?? ''  }}" required>
                                            </div>
                                            <div class="col-lg-6 ">
                                                <label for="postcode" class="fs-5  mb-2 darkerGrotesque-medium fw-bold"> Post code </label>
                                                <input type="text" name="postcode" class="form-control" id="postcode" value="{{ $step4dataForm['postcode'] ?? ''  }}" required>
                                            </div>
                                        ...
                                        <div class="col-lg-12 ">
                                            ...
                                            <input type="text" name="gov_issue_id" class="form-control" id="gov_issue_id" value="{{ $step4dataForm['gov_issue_id'] ?? ''  }}" required>
                                        </div>
