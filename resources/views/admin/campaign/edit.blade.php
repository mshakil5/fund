                            ...
                            <div class="col-lg-6" style="display:none">
                                <div>
                                    ...
                                    <select name="bank_account_class" id="bank_account_class"  class="form-control" required>
                                        <option value="">Select</option>
                                        <option value="Personal" @if((isset($data->bank_account_type))&&($data->bank_account_type=="Personal")) selected @endif>Personal</option>
                                        <option value="Corporate" @if((isset($data->bank_account_type))&&($data->bank_account_type=="Corporate")) selected @endif>Corporate</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6" style="display:none">
                                <div>
                                    ...
                                    <select name="bank_account_type" id="bank_account_type"  class="form-control" required>
                                        <option value="">Select</option>
                                        <option value="Checking" @if((isset($data->bank_account_type))&&($data->bank_account_type=="Checking")) selected @endif>Checking</option>
                                        <option value="Saving" @if((isset($data->bank_account_type))&&($data->bank_account_type=="Saving")) selected @endif>Saving</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-12">
